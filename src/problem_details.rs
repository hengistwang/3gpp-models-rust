...
pub struct ProblemDetails {
    ...
    pub invalid_params: Option<Vec<crate::InvalidParam>>,
    ...
    pub access_token_error: Option<Box<crate::AccessTokenErr>>,
    #[serde(rename = "accessTokenRequest", skip_serializing_if = "Option::is_none")]
    pub access_token_request: Option<Box<crate::AccessTokenReq>>,
