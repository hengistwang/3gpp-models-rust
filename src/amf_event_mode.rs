...
pub struct AmfEventMode {
    ...
    pub trigger: Box<crate::AmfEventTrigger>,
    ...
    pub partitioning_criteria: Option<Vec<crate::PartitioningCriteria>>,
...
impl AmfEventMode {
    ...
    pub fn new(trigger: crate::AmfEventTrigger) -> AmfEventMode {
        AmfEventMode {
