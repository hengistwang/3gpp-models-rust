...
pub struct SnssaiTaiMapping {
    ...
    pub reporting_area: Box<crate::TargetArea>,
    ...
    pub supported_snssai_list: Option<Vec<crate::SupportedSnssai>>,
}

impl SnssaiTaiMapping {
    /// List of restricted or unrestricted S-NSSAIs per TAI(s)
    pub fn new(reporting_area: crate::TargetArea) -> SnssaiTaiMapping {
        SnssaiTaiMapping {
