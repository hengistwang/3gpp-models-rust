...
pub struct UserLocation {
    ...
    pub eutra_location: Option<Box<crate::EutraLocation>>,
    #[serde(rename = "nrLocation", skip_serializing_if = "Option::is_none")]
    pub nr_location: Option<Box<crate::NrLocation>>,
    ...
    pub utra_location: Option<Option<Box<crate::UtraLocation>>>,
    #[serde(
        rename = "geraLocation",
        default,
        with = "::serde_with::rust::double_option",
    ...
    pub gera_location: Option<Option<Box<crate::GeraLocation>>>,
}
